...
if project == 'REP'
    ...
    print 'no EWC filtering is performed for CINDERELA'
#________________________________________________________________________________________________________________________________
#________________________________________________________________________________________________________________________________
...
print "Data has been filtered for waste generated in AMA"
...
#  Exclude all the LMA entries that are only referring to garden/landscaping waste
    ...
    print "Data has been filtered for garden/landscape related keywords"
...
# grouped_roles.to_excel('actor_roles.xlsx')

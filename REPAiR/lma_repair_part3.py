...
if scope == 'FW':
    ...
    #_________________________________________________________
    #       a) For connecting the fractios of FW according to the 'CBS Voedeselverspilling report'
    #_________________________________________________________
...
print len(Composition_table.index), 'different compositions have been exported'
if scope == 'FW':
...
print len(Flow_table_output.index), 'different flows have been exported'
